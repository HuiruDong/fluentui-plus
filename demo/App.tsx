...
const App = () => {
  const [currentDemo, setCurrentDemo] = React.useState<'tag' | 'inputTag' | 'overview'>('overview')
  ...
  const renderOverview = () => (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        >
          <h3 style={{ margin: '0 0 10px 0', color: '#52c41a', fontSize: '18px', fontWeight: '600' }}>InputTag 输入标签</h3>
          <p style={{ margin: 0, color: '#666', fontSize: '14px' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '14px', color: '#999' }}>
          本演示页面展示了 FluentUI Plus 组件库的各种组件和功能
        </div>
      </div>
    </div>
  )
